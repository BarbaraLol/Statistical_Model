...
The second model is significantly better than the null model, and it is also similar to the first model. Given the similarity of the deviance values, the lower complexity and the considerations about gluc variable, we select the nested model.
